...
public class NovelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent balik = new Intent(NovelActivity.this, MainActivity.class);
                startActivity(balik);
                finish();
            }
        });
    ...
    public void tampil_novel(){
        data = new ArrayList<>();
        Call<BookList> NovelCall = ClientAPI.getInstance().getMyApi().getNovels();
        NovelCall.enqueue(new Callback<BookList>() {
            @Override
